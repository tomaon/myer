...
%%
%% stmt_prepare: CREATE PROCEDURE x34 (
%%                 INOUT i_inout INT
%%               )
%%               BEGIN
...
%%               END
%%
%% stmt_execute: CALL x34(?)
%%
%% recv
%% -- fields.length (1/2)
%%  1,0,0,  1, 1,
%% -- fields (1/2)
%% 27,0,0,  2, 3,100,101,102,0,0,0,5,118,97,108,117,101,0,12,63,0,12,0,0,0,8,128,0,0,0,0,
%%  5,0,0,  3, 254,0,0,10,0,
%% -- rows (1/2)
%% 10,0,0,  4, 0,0,3,0,0,0,0,0,0,0,
%%  5,0,0,  5, 254,0,0,10,0,
%% -- fields.length (2/2)
%%  1,0,0,  6, 1,
%% -- fields (2/2)
%% 27,0,0,  7, 3,100,101,102,0,0,0,5,118,97,108,117,101,0,12,63,0,12,0,0,0,8,128,0,0,0,0,
%%  5,0,0,  8, 254,0,0,10,0,
%% -- rows (2/2)
%% 10,0,0,  9, 0,0,4,0,0,0,0,0,0,0,
%%  5,0,0, 10, 254,0,0,10,0,
%% -- result
%%  7,0,0, 11, 0,0,0,2,0,0,0
