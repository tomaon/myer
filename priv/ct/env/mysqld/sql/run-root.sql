...
SET old_passwords = 0; SET PASSWORD FOR 'test'@'127.0.0.1' = PASSWORD('test');
...
SET old_passwords = 1; SET PASSWORD FOR 'test_oldpwd'@'127.0.0.1' = PASSWORD('test');
...
/*!50606 SET old_passwords = 2; SET PASSWORD FOR 'test_sha256pwd'@'127.0.0.1' = PASSWORD('test') */;
